...
<div class="container">
    ...
    <form method="POST" action="/admin/viaturas/guardar" id="form_viatura" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                ...
                <input name="preco" type="number" class="form-control" id="preco" required>
            </div>
            <div class="form-group col-md-3">
                <label for="exampleFormControlInput1">KM*</label>
                <input name="km" type="number" class="form-control" id="km" required>
            </div>
            <div class="form-group col-md-3">
                <label for="exampleFormControlInput1">Data de Registo*</label>
                <input name="registo" type="month" class="form-control" id="registo" required>
            </div>
            <div class="form-group col-md-3">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input name="cilindrada" type="Number" class="form-control" id="cilindrada" required>
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input name="portas" type="number" class="form-control" value="0" id="portas">
            </div>
            <div class="form-group col-md-6">
                <label for="exampleFormControlInput1">Lotação</label>
                <input name="lotacao" type="number" class="form-control" id="lotacao">
            </div>
        </div>
        <!-- caixa tracao -->
        ...
        <div>
            ...
            <textarea name="extra" class="form-control" id="article-ckeditor" rows="5"></textarea>
        </div>
        <br>
...
<!--editor-->
<!--options-->
<script type="text/javascript" src="/js/tipocarro.js"></script>
<script>
